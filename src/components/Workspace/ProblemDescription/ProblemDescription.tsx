          ...
          <div className="w-full">
            <div className="flex space-x-4">
              ...
              <div className=" flex items-center mt-3">
                <div
                  className={`text-olive bg-olive inline-block rounded-[21px] bg-opacity-[.15] px-2.5 py-1 font-medium text-xs capitalize`}
                >
                  Easy
                </div>
            ...
            <div className="text-white text-sm">
              <p className="mt-3">
                Given an array of itegers <code>nums</code> and an integer{" "}
