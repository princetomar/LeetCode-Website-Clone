...
export default function Home() {
  ...
  //   // LEt's convert the problems order into integer
  //   const newProblem = {
  //     ...problemInputs,
  //     order: Number(problemInputs.order),
  //   };
  //   await setDoc(doc(firestore, "problems", problemInputs.id), newProblem);
...
const LoadinSkeleton = () => {
  return (
    <div className=" flex items-center space-x-12 mt-4 px-4">
